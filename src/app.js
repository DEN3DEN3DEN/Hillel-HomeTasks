...
let digitD = parseInt((numberABCDEF / 100) % 10);
let digitE = parseInt((numberABCDEF / 10) % 10);
let digitF = parseInt(numberABCDEF % 10);

if (digitA===digitF && digitB===digitE && digitC===digitD) {
